...
var UserService = /** @class */ (function() {
  ...
  UserService.prototype.createUser = function(user, authorizedCategoryIds) {
    ...
    var rolesCheck = ["admin", "sales", "staff", "supplier", "retailer", "franchiser"];
    ...
    if (authorizedCategoryIds) {
      ...
      authorizedCategoryIds.forEach(function(authorizedCategoryId) {
        return (user.authorizedCategoryIds[authorizedCategoryId] = true);
      });
    }
    var body = { user: user };
  ...
  UserService.prototype.login = function(email, password, onLogoutListener) {
    ...
    return CoreServiceHelper_1.CoreServiceHelper.getHelper()
      .post(Settings_1.Settings.SERVER_CONFIG.connections.api_login, "application/json", JSON.stringify(body))
  ...
  UserService.prototype.logout = function() {
    var _this = this;
    return CoreServiceHelper_1.CoreServiceHelper.getHelper()
      .post(Settings_1.Settings.SERVER_CONFIG.connections.api_logout, "application/json", JSON.stringify({}))
      .then(function(result) {
